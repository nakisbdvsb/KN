...
export const DESIGN_LIFECYCLE_STEPS = [
  ...
  { key: "final_submitted", label: "Final (warna + mockup)" },
...
export const DESIGN_EVENT_LABEL = {
  ...
  request_revision: "Diminta revisi (ronde baru dibuka)", approve: "Disetujui (ACC)",
  ...
  mockup_uploaded: "Mockup diunggah", colorway_uploaded: "Varian warna final diunggah",
};
